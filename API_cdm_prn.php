<?php
        ...
        $db = odbc_connect($connection_string, "eqcas", "eqcas") or die ("could not connect<br />");
            //run sql query
            $stmt = "SELECT Top 1000
                        v3_CDM.CalendarPeriod,
                        v3_CDM.PageCount,
                        v3_CDM.Amount,
                        v3_CDM.Type,
                        v3_CDM.trxtype,
                        v3_CDM.CompanyNumber,
                        v3_CDM.DisplayName,
                        v3_CDM.EmployeeEmailAddress,
                        v3_CDM.JobTitle,
                        v3_CDM.Department,
                        v3_CDM.ContractingCompany,
                        v3_CDM.ReportToFullName,
                        v3_CDM.ReportToEmailAddress
                        From
                        v3_CDM
