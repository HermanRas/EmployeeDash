<?php
        ...
        $db = odbc_connect($connection_string, "EAIEmployeeUpdate", "EAIEmployeeUpdate") or die ("could not connect<br />");
            //run sql query
            $stmt = "   SELECT 
                        vVPN2_Logs.tDateTimeOn,
                        vVPN2_Logs.[Display Name],
                        vVPN2_Logs.tSurname,
                        vVPN2_Logs.tDuration,
                        vVPN2_Logs.tInputOctets,
                        vVPN2_Logs.tOutputOctets,
                        vVPN2_Logs.CompanyNumber,
                        vVPN2_Logs.ReportToLogonId
                        FROM vVPN2_Logs
