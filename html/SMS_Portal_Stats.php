...
<head>
    ...
    <title>SMS from Portal - Summary</title>
...
<body class="bg-primary">
    ...
    <div class="pt-3 container bg-white rounded">
        ...
        <div class="card my-3">
            <div class="card-header bg-dark text-white">
                Last Month SMS from Portal Report:
            </div>
        ...
        <a class="btn btn-outline-primary btn-lg form-control" href="<?php
                                                                        ...
                                                                        echo $url . 'SMS_Portal_Stats.php?fDate=' . $fDate;
                                                                        ?>">
    ...
    <script src="js/loader_sms_portal.js"></script>
