...
<head>
    ...
    <link rel="icon" href="https://dat-ser-web-01.petragroup.local/EmployeeDash/img/icon.png" sizes="192x192">
 ...
 */
        ...
        *::after {
        ...
        .custom-select.is-valid:focus {
            border-color: #0074E4;
            box-shadow: 0 0 0 0.2rem rgba(0, 116, 228, 0.25);
        }
        ...
        .was-validated .custom-control-input:valid:focus~.custom-control-label::before,
        .custom-control-input.is-valid:focus~.custom-control-label::before {
            box-shadow: 0 0 0 1px #fff, 0 0 0 0.2rem rgba(0, 116, 228, 0.25);
        }
        ...
        .invalid-tooltip {
            ...
            line-height: 1;
            color: #fff;
            background-color: rgba(255, 64, 87, 0.8);
            border-radius: .2rem;
        }
        ...
        .was-validated .custom-control-input:invalid:focus~.custom-control-label::before,
        .custom-control-input.is-invalid:focus~.custom-control-label::before {
            box-shadow: 0 0 0 1px #fff, 0 0 0 0.2rem rgba(255, 64, 87, 0.25);
        }
        ...
        .custom-checkbox .custom-control-input:disabled:checked~.custom-control-label::before {
            background-color: rgba(8, 51, 88, 0.5);
        }
        ...
        .custom-select:focus {
            border-color: #1377cd;
            outline: 0;
            box-shadow: inset 0 1px 2px rgba(0, 0, 0, 0.075), 0 0 5px rgba(19, 119, 205, 0.5);
        }
    ...
    <div class="pt-3 container bg-white rounded">
        ...
        <nav class="navbar navbar-dark bg-dark rounded">
            <a class="navbar-brand" href="index.php">
                <img src="https://dat-ser-web-01.petragroup.local/EmployeeDash/img/single.jpg" width="30" height="30" class="d-inline-block align-top bg-white rounded" alt="">
            ...
            <div class="row bg-white">
                <div class="col-12 bg-white text-center">
                    <div class="bg-dark p-1 my-1 rounded inline" style="margin: auto;">
                        <div class="justify-content-center" id="mini-gallery-row">
        ...
        <div class="card my-3">
            <div class="card-header bg-dark text-white">
                Your Team's Telephone Report:
            </div>
            <div class="card-body bg-light">
                <?php include_once("API_telEmail.php") ?>
                <!-- Table End -->
            </div>
        </div>
        <!-- Form Summary -->
