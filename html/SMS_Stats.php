...
<head>
    ...
    <title>E-Mail to SMS Summary</title>
...
<body class="bg-primary">
    ...
    <div class="pt-3 container bg-white rounded">
        ...
        <div class="card my-3">
            <div class="card-header bg-dark text-white">
                Last Month E-Mail to SMS Report:
            </div>
        ...
        <a class="btn btn-outline-primary btn-lg form-control" href="<?php
                                                                        ...
                                                                        echo $url . 'SMS_Stats.php?fDate=' . $fDate;
                                                                        ?>">
    ...
    <script src="js/loader_sms.js"></script>
